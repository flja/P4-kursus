        ...
        public void check() throws Exception
        {
            if (true)
            {
                ...
                while (i < playercount)
                {
                    ...
                    else if (players.get(j - 1).playerHand.totalValue() == table.dealerHand.totalValue() && table.dealerHand.totalValue() == 21)
                    {
                    ...
                    else if (players.get(j - 1).playerHand.totalValue() == table.dealerHand.totalValue())
                    {
                    ...
                    else if (players.get(j - 1).playerHand.totalValue() == 21)
                    {
                        HelpMethods.printString("Player ");
                        HelpMethods.printNumber(j);
